...
<head>
    ...
    <title>404 | academy.Tunivisions.Link</title>
    ...
    <div class="www-layout">
        <section>
            <div class="gap no-gap">
                <div class="eror-robot">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="error-page">
                                <a title="" href="#"><img alt="" src="<?php echo base_url() ?>assets/images/logo.png"></a>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-5">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-7">
                                            <div class="robo-meta">
                                                <div class="v-center">
                                                  <h1> <?php echo ''; ?> </h1>
                                                  <span>The requested URL was not found on the server</span>
                                                  <p><?php echo ''; ?>
                                                  </p>
                                                  <a href="<?php echo base_url(); ?>" title="" class="main-btn">Back to Home</a>
                                                 </div>
                                             </div> 
                                        </div>
                                    </div>
        ...
        <script src="<?php echo base_url() ?>assets/s/main.min.js"></script>
